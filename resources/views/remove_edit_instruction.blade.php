...
<html>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-md" role="banner" style="background-image: url(images/img_bg_2.jpg)">
      ...
      <table id='customers' border='1' bold><tr>
			...
			<td>REMOVE</td>
			<td>EDIT</td></tr>
			@foreach($instruction as $details)
						    
      			          					<div style='overflow-x:auto;'><tr><td>{{$details->id}}
      			    <br/></td><td>{{$details->instruction}}
      			    <br/>
      			    <td><a href='/remove_delete_instruction/{{$details->id}}'>
      				<button class='btn danger' onclick='myFunction()'>Remove</button></a></td>
							
               <td><a href='edit_instruction/{{$details->id}}'>
